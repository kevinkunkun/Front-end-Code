...
(function ($, window, document, undefined) {
	...
	Plugin.prototype = {
		...
		init: function ()
		{
			...
			this.orig_item_width = this.$viewport[0].offsetWidth/this.items_count -30;//this.$items.outerWidth(true);
			// if(this.$viewport[0].offsetWidth>=bigSize){
			// 	this.orig_item_width = 360;
			// }else if(this.$viewport[0].offsetWidth<bigSize&&this.$viewport[0].offsetWidth>=midleSize){
			// 	this.orig_item_width = 260;
			// }else if(this.$viewport[0].offsetWidth<midleSize&&this.$viewport[0].offsetWidth>480){
			// 	this.orig_item_width = 240;
			// }else{
			// 	this.orig_item_width = 120;
			// }
			this.orig_item_width = 
		...
		calc_variables: function()
		{
			...
			if(this.options.centered || this.options.dont_cut) {
				...
				// if(this.viewport_width>=1492){
				// 	this.item_width = 360;
				// }else if(this.viewport_width<1492&&this.viewport_width>=1440){
				// 	this.item_width = 260;
				// }else if(this.viewport_width<1440&&this.viewport_width>480){
				// 	this.item_width = 240;
				// }else{
				// 	this.item_width = 160;
				// }
				...
				this.$element.css({width: this.full_items_width+60 + 'px'});
			}
